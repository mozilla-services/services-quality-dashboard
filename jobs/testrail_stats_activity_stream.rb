...
SCHEDULER.every '60m', :first_in => 0 do |job|
  ...
  send_event('testrail_activity_stream_total_tasks_count', { current: total_tasks_count})
  send_event('testrail_activity_stream_untriaged_tasks_count', { current: untriaged_tasks_count})
  send_event('testrail_activity_stream_suitable_tasks_count', { current: suitable_tasks_count})
  send_event('testrail_activity_stream_unsuitable_tasks_count', { current: unsuitable_tasks_count})
  send_event('testrail_activity_stream_completed_tasks_count', { current: completed_tasks_count})

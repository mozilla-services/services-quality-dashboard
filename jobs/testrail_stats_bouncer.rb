...
SCHEDULER.every '60m', :first_in => 0 do |job|
  ...
  # Bouncer is project #33
  # https://testrail.stage.mozaws.net/index.php?/projects/overview/33
  project_id = 33
  ...
  send_event('tr_bouncer_auto_versus_total', { value: possible_automation_pct})
  send_event('tr_bouncer_auto_coverage_total', { value: automation_coverage_pct})
  send_event('tr_bouncer_defects_last_30_days', points: failures_last_30_days)
  send_event('tr_bouncer_total_cases_count', { current: total_cases_count, last: last_total_cases_count })
  send_event('tr_bouncer_failures_avg_per_run', { current: failures_per_run, last: last_failures_per_run })
  send_event('tr_bouncer_total_failure_count', { current: failure_count, last: last_failure_count })
  send_event('tr_bouncer_regressions_avg_per_run', { current: regressions_per_run, last: last_regressions_per_run })
  send_event('tr_bouncer_total_regression_count', { current: regression_count, last: last_regression_count })
